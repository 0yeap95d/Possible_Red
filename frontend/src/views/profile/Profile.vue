<template>
    <div class="wrap">
        <v-app>
            <v-card
                class="mx-auto overflow-hidden missions"
            ...
            >
                ...
                <v-toolbar-title>USER'S NAME</v-toolbar-title>
                ...
                >
                    ...
                    >
                        ...
                        <v-list-item @click="mysetting">
                            <v-list-item-icon >
                                <i class="fas fa-user-cog"></i>
                            </v-list-item-icon>
                            <v-list-item-title>내 계정 설정</v-list-item-title>
                        </v-list-item>
                        </v-list-item-group>
                    </v-list>
                </v-navigation-drawer>
