      ...
      <v-dialog v-model="dialog" width="600px">
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <p>2.가입희망 회원은 반드시 자신의 본명 및 주민등록번호로 이용신청을 하여야 하며, 1개의 ID만 신청을 할 수 있습니다.</p>
            <br>
            <p>제7조 (회원가입의 승낙)</p>
            <p>'갑'의 회원 가입 신청 양식에 가입 희망 회원이 인터넷으로 제6조와 같이 신청하면 '갑'은 바로 가입을 승인하여 서비스를 이용할 수 있다.</p>
            <br>
            <p>제8조(회원가입 신청거절 및 강제 탈퇴)</p>
            <p>1. '갑'은 타인의 명의나 주민등록번호를 도용하여 회원가입신청을 할 경우 회원가입신청을 거절할 수 있다.<br>
            ...
            제 1 조 (시행일) 이 약관은 2013년 11월 30일부터 시행한다.</p>
            <br>
          </v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
